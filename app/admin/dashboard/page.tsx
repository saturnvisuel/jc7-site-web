    ...
    <div className="min-h-screen bg-muted/50">
      <header className="bg-background border-b">
        <div className="container mx-auto px-4 sm:px-6 py-4 flex justify-between items-center">
          <h1 className="text-xl sm:text-2xl font-bold">JC7 Admin Dashboard</h1>
      ...
      <main className="container mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="mb-6 sm:mb-8">
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Vue d&apos;ensemble des inscriptions</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <div className="bg-background p-4 sm:p-6 rounded-lg shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl sm:text-3xl font-bold">{paid}</span>
            </div>
          ...
          <div className="bg-background p-4 sm:p-6 rounded-lg shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl sm:text-3xl font-bold">{pending}</span>
            </div>
          ...
          <div className="bg-background p-4 sm:p-6 rounded-lg shadow">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-2xl sm:text-3xl font-bold">{cancelled}</span>
            </div>
        ...
        {pendingCashCheck > 0 && (
          <div className="bg-amber-50 border-l-4 border-amber-600 p-4 sm:p-6 rounded-lg shadow mb-6 sm:mb-8">
