...
import { LogIn, Award, Users, Calendar, Shield } from "lucide-react";
...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-red-600 via-red-500 to-red-700 min-h-[90vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20 relative z-10 w-full">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <p className="text-2xl md:text-3xl lg:text-4xl text-white/95 mb-6 font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button 
                asChild 
                size="lg" 
                className="rounded-full px-10 py-7 text-lg font-semibold bg-white text-red-600 hover:bg-gray-50 hover:scale-105 transition-all shadow-2xl"
              >
              ...
              <Button 
                ...
                variant="outline" 
                size="lg"
                className="rounded-full px-10 py-7 text-lg font-semibold border-2 border-white bg-white/20 text-white hover:bg-white hover:text-red-600 backdrop-blur-md transition-all shadow-lg"
              >
